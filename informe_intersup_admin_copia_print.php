...
require_once("include/informe_intersup_admin_copia_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "informe_intersup_admin_copia" );
