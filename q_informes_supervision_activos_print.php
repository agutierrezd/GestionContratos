...
require_once("include/q_informes_supervision_activos_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "q_informes_supervision_activos" );
