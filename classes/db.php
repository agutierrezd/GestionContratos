...
class DB
{
	...
	protected static function _fillTablesList()
	{
		...
		if( "dbct_at_localhost" == $conn->connId )
		{
			...
			$dalTables[$conn->connId][] = array("name" => "q_informes_supervision_activos", "varname" => "dbct_at_localhost__q_informes_supervision_activos", "altvarname" => "q_informes_supervision_activos", "connId" => "dbct_at_localhost", "schema" => "", "connName" => "dbct at localhost");
