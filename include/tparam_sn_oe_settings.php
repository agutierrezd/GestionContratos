...
$tdatatparam_sn_oe[".pagesByType"] = my_json_decode( "{}" );
$tdatatparam_sn_oe[".originalPagesByType"] = $tdatatparam_sn_oe[".pagesByType"];
$tdatatparam_sn_oe[".pages"] = types2pages( my_json_decode( "{}" ) );
$tdatatparam_sn_oe[".originalPages"] = $tdatatparam_sn_oe[".pages"];
$tdatatparam_sn_oe[".defaultPages"] = my_json_decode( "{}" );
...
$tdatatparam_sn_oe[".popupPagesLayoutNames"] = $popupPagesLayoutNames;
...
$tdatatparam_sn_oe[".rowHighlite"] = true;
...
$tableEvents["tparam_sn_oe"] = new eventsBase;
