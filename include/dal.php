...
class tDAL
{
	...
	var $tbldbct_at_localhost__q_informes_supervision_activos;
	...
	function FillTablesList()
	{
		...
		$this->lstTables[] = array("name" => "q_informes_supervision_activos", "varname" => "dbct_at_localhost__q_informes_supervision_activos", "altvarname" => "q_informes_supervision_activos", "connId" => "dbct_at_localhost", "schema" => "", "connName" => "dbct at localhost");
