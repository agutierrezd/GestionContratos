...
require_once("include/interventor_interno_sup_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "interventor_interno_sup" );
